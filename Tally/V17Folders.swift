        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    editorCard("Quick Create Presets") {
                        HStack {
                            Text("Step Buttons")
                            Spacer()
                        ...
                        Text("The shortcut beside this folder can create a preset counter or create one and immediately start a linked session.")
        ...
        NavigationStack {
            VStack(spacing: 18) {
                ...
                TextField("Name", text: $name)
                    ...
                    .font(.title3.weight(.semibold))
                Text("Uses the presets from \(folder.name).")
                ...
                VStack(spacing: 10) {
                    Button {
                        ...
                        Label("Create Counter", systemImage: "number.square.fill")
                    ...
                    Button {
                        ...
                        Label("Create & Start Timer", systemImage: "timer")
                            .frame(maxWidth: .infinity)
                    }
